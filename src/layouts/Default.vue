<template>
  <div>
    ...
    >
      ...
      >
      <a
        href="https://blog.csdn.net/cloveryuan/article/details/108705457"
        class="btn"
        target="_blank"
        ...
        <el-row>
          ...
          <el-col :span="2" style="text-align: center">
            ...
            >
              ...
              <br />
              <img :src="`${GRIDSOME_API_URL + configguration.avatarUrl.url}`" style="width: 200px; height: 200px" />
            </el-popover>
          </el-col>
        </el-row>
      </el-card>
...
export default {
  ...
  data() {
    return {
      ...
      randomIcon: [],
      webSites:[
        {"name":"简书" , "url":"https://www.jianshu.com/u/b45573424ec4"}
      ]
    };
  },
  computed:{
    configguration(){
      return this.$static.strapiConfigguration
    }
  },
  watch: {
  ...
  methods: {
    selectTopbar(index) {
      ...
      switch (index) {
        case "#githubHome":
          window.open("https://github.com/" + this.configguration.githubUsername);
          break;
        case "#blog":
          if (this.configguration.blog) {
            window.open(
              (this.configguration.blog.match(/https?:\/\//i) ? "" : "https://") + this.configguration.blog
            );
          } else {
            this.$message({
              message: "博主没有其他博客",
